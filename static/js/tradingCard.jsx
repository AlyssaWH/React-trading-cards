...
ReactDOM.render(
  <TradingCard name="Merge the Mercat!!" skill="Foosball" imgUrl="/static/img/merge.png" />,
  document.querySelector('#merge')
);

ReactDOM.render(
  <TradingCard name="Polymorphism" skill="sleeping" imgUrl="/static/img/polymorphism.jpeg" />,
